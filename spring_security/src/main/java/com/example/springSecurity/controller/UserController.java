...
public class UserController {
    ...
    private final com.example.springSecurity.service.UserService userService;
    ...
    public ResponseEntity<com.example.springSecurity.dto.ApiResponse> deleteUser(@PathVariable(value = "userId") Long userId) throws CustomException {
        try {
            userService.deleteUserById(userId);
            return ResponseEntity.ok(new com.example.springSecurity.dto.ApiResponse(HttpStatus.OK, com.example.springSecurity.enums.ApiResponsesEnum.USER_DELETED_SUCCESSFULLY.getValue()));
        } catch (Exception e) {
