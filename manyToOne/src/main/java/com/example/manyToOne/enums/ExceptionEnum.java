...
public enum ExceptionEnum {
    ...
    Organization_DELETED_WITH_ID("Organization Deleted Successfully", "Organization_DELETED_WITH_ID"),


    Organization_WITH_ID_NOT_FOUND("Organization with id not found", "Organization_WITH_ID_NOT_FOUND");
