...
import com.example.core.dto.ErrorDTO;
...
public class GlobalExceptionHandlerController {
    ...
    @ExceptionHandler(com.example.core.exception.CustomException.class)
    public ResponseEntity<ApiResponse> handleCustomException(HttpServletRequest req, com.example.core.exception.CustomException e) {
